...
const Layout = () => {
  ...
  useEffect(() => {
    if (!user || !['owner', 'master_admin', 'admin', 'admin'].includes(user?.role)) return;
    let cancelled = false;
  ...
  // Roles: owner (master_admin), team_lead, manager
  const navGroups = [
    {
      id: 'dashboard',
      type: 'single',
      item: { path: '/admin', icon: ChartPieSlice, labelKey: 'dashboard' },
      roles: ['owner', 'master_admin', 'admin', 'team_lead', 'manager']
    },
    {
      id: 'crm',
      type: 'group',
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/admin/owner-dashboard', icon: ChartLine, labelKey: 'paymentAnalytics', roles: ['owner', 'master_admin', 'admin'] },
        { path: '/admin/invoice-reminders', icon: PhoneCall, labelKey: 'invoiceReminders', roles: ['owner', 'master_admin', 'admin', 'team_lead'] },
      ],
      roles: ['owner', 'master_admin', 'admin', 'team_lead']
    },
    {
      id: 'auto',
      type: 'group',
      ...
      roles: ['master_admin', 'moderator', 'owner', 'admin', 'team_lead']
    },
    {
      id: 'team',
      type: 'group',
    ...
    },
    {
      ...
      roles: ['owner', 'master_admin', 'admin']
    },
    {
      id: 'settings',
      type: 'group',
      ...
      icon: Sliders,
      items: [
        { path: '/admin/integrations', icon: Plugs, labelKey: 'integrations', roles: ['owner', 'master_admin', 'admin'] },
        // Tracking-hub items moved to top-level `/admin/tracking` (see TrackingLayout.jsx)
        { path: '/admin/ringostat', icon: Phone, labelKey: 'ringostat', roles: ['owner', 'master_admin', 'admin'] },
        {
        ...
        // DEPRECATED: Chrome Extension (Copart automation) - focusing on Bitmotors only
        // { path: '/admin/parser/chrome-extension', icon: Globe, label: 'Chrome Extension' },
        { path: '/admin/settings', icon: Wrench, labelKey: 'system' },
      ],
      roles: ['master_admin', 'moderator', 'owner', 'admin']
    },
    {
      id: 'analytics',
      type: 'group',
