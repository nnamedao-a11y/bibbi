  ...
  return (
    <motion.div data-testid="deposits-page" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#18181B]" style={{ fontFamily: 'Cabinet Grotesk, sans-serif' }}>{t('depositsTitle')}</h1>
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="w-[calc(100vw-32px)] max-w-md mx-auto bg-white rounded-2xl border border-[#E4E4E7]" data-testid="deposit-modal">
          <DialogHeader><DialogTitle className="text-xl font-bold text-[#18181B]" style={{ fontFamily: 'Cabinet Grotesk, sans-serif' }}>{t('newDeposit')}</DialogTitle></DialogHeader>
